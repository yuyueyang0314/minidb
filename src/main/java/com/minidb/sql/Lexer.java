...
public class Lexer {
    ...
    public List<Token> lex(){
        ...
        while(true){
            ...
            } else if (c=='\''){ int j=++i; while(!eof() && peek()!='\'') i++; out.add(new Token(TokenType.STRING, s.substring(j,i))); i++; }
            else {
                i++;
                switch(c){
                    ...
                    case '<' -> out.add(new Token(TokenType.LT, "<"));
                    case '>' -> out.add(new Token(TokenType.GT, ">"));
